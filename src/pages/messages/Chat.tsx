                                          ...
                                          {resource.payload.map((content, contentIndex) => (
                                            <React.Fragment key={contentIndex}>
                                              ...
                                              {content.contentAttachment?.url && (
                                                ...
                                                >
                                                  <DocumentArrowDownIcon className="mr-1 h-6 w-6 text-blue-600 group-hover:text-blue-700" />
                                                  Descargar adjunto
                                                </a>
                                              )}
                                            </React.Fragment>
                      ...
                      <div>
                        <UploadButton onUpload={(value: Attachment) => setAttachment(value)}>
                          <div className="group flex">
                            <div className="flex items-center rounded-l-md bg-blue-600 px-2 group-hover:bg-gray-700">
                              {attachment ? (
